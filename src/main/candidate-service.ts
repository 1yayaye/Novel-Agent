...
/**
 * Computes Longest Common Subsequence of generic array items with Myers' shortest edit script.
 */
function lcs<T>(
  a: T[],
  b: T[],
 ...
 * Implements two-pointer common prefix-suffix trimming to minimize diff input allocations (ADR 0002).
 */
